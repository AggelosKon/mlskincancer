...
def run_sgd(epochs = 10, input_dim=(256, 256, 3), batch_size = 64, alpha = 1e-5, rescale_factor = 1./255):
    import time
    np.random.seed(123)
    ...
    print('Start training process for the SGD model...')
    ...
    print('Training process for the SGD model was sucessful!')
    
    # Evaluate the model on test set
    print('Start evaluating the SGD model on test set...')
    ...
    print(image_num, 'images processed')
    print('SGD model was evaluated on test set successfully!')
